    ...
    public sealed class HookPool
    {
        ...
        internal TypeBuilder Constructor(uint numHook)
        {
            if (_moduleBuilder == null)
            {
                ...
                _asmBuilder = AssemblyBuilder.DefineDynamicAssembly(an, AssemblyBuilderAccess.Run);
                _moduleBuilder = _asmBuilder.DefineDynamicModule(an.Name);
            }
